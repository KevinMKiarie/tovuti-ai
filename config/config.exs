...
config :tovuti_ai, TovutiAiWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: TovutiAiWeb.ErrorHTML, json: TovutiAiWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: TovutiAi.PubSub,
  live_view: [signing_salt: "2pAKPJLD"]
...
config :tovuti_ai, TovutiAi.Mailer, adapter: Swoosh.Adapters.Local
