defmodule TovutiAiWeb.UserAuthTest do
  use TovutiAiWeb.ConnCase, async: true

  alias TovutiAi.Accounts
  alias TovutiAi.Accounts.Scope
  alias TovutiAiWeb.UserAuth

  import TovutiAi.AccountsFixtures

  @remember_me_cookie "_tovuti_ai_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, TovutiAiWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
